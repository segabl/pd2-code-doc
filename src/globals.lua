...
managers.camera = nil ---@type CoreCameraManager.CameraTemplateManager
managers.challenge = nil ---@type ChallengeManager
managers.charm = nil ---@type CharmManager
managers.chat = nil ---@type ChatManager
managers.controller = nil ---@type CoreControllerManager.ControllerManager
...
managers.cutscene = nil ---@type CoreCutsceneManager
managers.database = nil ---@type CoreDatabaseManager.DatabaseManager
managers.dialog = nil ---@type DialogManager
managers.DOF = nil ---@type CoreDOFManager.DOFManager
...
managers.environment_area = nil ---@type CoreEnvironmentAreaManager.EnvironmentAreaManager
managers.environment_controller = nil ---@type CoreEnvironmentControllerManager
managers.environment_effects = nil ---@type CoreEnvironmentEffectsManager.EnvironmentEffectsManager
...
managers.expression = nil ---@type CoreExpressionManager.ExpressionManager
...
managers.global_texture = nil ---@type CoreGTextureManager.GTextureManager
managers.groupai = nil ---@type GroupAIManager
managers.gui_data = nil ---@type GuiDataManager
managers.helper_unit = nil ---@type CoreHelperUnitManager.HelperUnitManager
...
managers.listener = nil ---@type CoreListenerManager.ListenerManager
...
managers.mission = nil ---@type CoreMissionManager.MissionManager
...
managers.overlay_effect = nil ---@type CoreOverlayEffectManager.OverlayEffectManager
...
managers.portal = nil ---@type CorePortalManager.PortalManager
...
managers.rumble = nil ---@type CoreRumbleManager.RumbleManager
managers.savefile = nil ---@type SavefileManager
managers.sequence = nil ---@type CoreSequenceManager.SequenceManager
managers.shape = nil ---@type CoreShapeManager.ShapeManager
managers.skilltree = nil ---@type SkillTreeManager
managers.skirmish = nil ---@type SkirmishManager
managers.slave = nil ---@type CoreSlaveManager.SlaveManager
managers.slot = nil ---@type SlotManager
managers.socialhub = nil ---@type SocialHubManager
managers.sound_environment = nil ---@type CoreSoundEnvironmentManager
...
managers.subtitle = nil ---@type CoreSubtitleManager.SubtitleManager
...
managers.user = nil ---@type UserManager.GenericUserManager
managers.vehicle = nil ---@type VehicleManager
managers.video = nil ---@type VideoManager
managers.viewport = nil ---@type CoreViewportManager.ViewportManager
...
managers.world_instance = nil ---@type CoreWorldInstanceManager
managers.worldcamera = nil ---@type CoreWorldCameraManager
